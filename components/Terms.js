...
const Terms = () => {
  return (
    <div className="terms-container">
      ...
      <p className="text-light">
        This website is operated by Nora Proxies. Throughout the site, the terms
        “we”, “us” and “our” refer to Nora Proxies. Nora Proxies offers this
      ...
      <p className="text-light">
        <h1 className="text-light">SECTION 1 - ONLINE STORE TERMS</h1>
      </p>
      <p className="text-light">
      ...
      <p className="text-light">
        <h1 className="text-light">SECTION 2 - GENERAL CONDITIONS</h1>
      </p>
      <p className="text-light">
      ...
      <p className="text-light">
        <h1 className="text-light">SECTION 7 - OPTIONAL TOOLS</h1>
      </p>
      <p className="text-light">
      ...
      <p className="text-light">
        <h1 className="text-light">SECTION 8 - THIRD-PARTY LINKS</h1>
      </p>
      <p className="text-light">
      ...
      <p className="text-light">
        <h1 className="text-light">SECTION 10 - PERSONAL INFORMATION</h1>
      </p>
      <p className="text-light">
      ...
      <p className="text-light">
        <h1 className="text-light">SECTION 12 - PROHIBITED USES</h1>
      </p>
      <p className="text-light">
      ...
      <p className="text-light">
        ...
        <br />
        In no case shall Nora Proxies, our directors, officers, employees,
      ...
      <p className="text-light">
        <h1 className="text-light">SECTION 14 - INDEMNIFICATION</h1>
      </p>
      <p className="text-light">
        You agree to indemnify, defend and hold harmless Nora Proxies and our
      ...
      <p className="text-light">
        <h1 className="text-light">SECTION 15 - SEVERABILITY</h1>
      </p>
      <p className="text-light">
      ...
      <p className="text-light">
        <h1 className="text-light">SECTION 16 - TERMINATION</h1>
      </p>
      <p className="text-light">
      ...
      <p className="text-light">
        <h1 className="text-light">SECTION 17 - ENTIRE AGREEMENT</h1>
      </p>
      <p className="text-light">
      ...
      <p className="text-light">
        <h1 className="text-light">SECTION 18 - GOVERNING LAW</h1>
      </p>
      <p className="text-light">
      ...
      <p className="text-light">
        <h1 className="text-light">SECTION 19 - CHANGES TO TERMS OF SERVICE</h1>
      </p>
      <p className="text-light">
      ...
      <p className="text-light">
        <h1 className="text-light">SECTION 20 - CONTACT INFORMATION</h1>
      </p>
      <p className="text-light">
        Questions about the Terms of Service should be sent to us at
        support@noraproxies.io.
      </p>
    </div>
  );
};
