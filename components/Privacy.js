  ...
  return (
    <div className="terms-container">
      ...
      <p className="text-light">
        ...
        https://www.noraproxies.io (the “Site”).
      </p>

      <h1 className="text-light">PERSONAL INFORMATION WE COLLECT</h1>
      ...
      <h1 className="text-light">HOW DO WE USE YOUR PERSONAL INFORMATION?</h1>
      ...
      <p className="text-light">
        ...
        to:- Communicate with you;- Screen our orders for potential risk or
        fraud; and- When in line with the preferences you have shared with us,
      ...
      <h1 className="text-light">SHARING YOUR PERSONAL INFORMATION</h1>
      ...
      <h1 className="text-light">BEHAVIOURAL ADVERTISING</h1>
      <p className="text-light">
      ...
      <h1 className="text-light">DO NOT TRACK</h1>
      <p className="text-light">
        Please note that we do not alter our Site’s data collection and use
        practices when we see a Do Not Track signal from your browser.
      </p>
      <h1 className="text-light">YOUR RIGHTS</h1>
      <p className="text-light">
