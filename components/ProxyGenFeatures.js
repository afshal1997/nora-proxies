          ...
          <div className="packages">
            <div className="row">
              <div className="col-lg-4" data-aos="flip-left">
                <div className="card text-light mall position-relative">
                  <img className="w-100" src="imgs/home/mallImg01.png" alt="mallImg01" />
                  <div className="card-body">
                    <h2>T1</h2>
                    <p>Aged since 2008</p>
                    <p>Generated on a unique IP Address</p>
                    <p>Guaranteed V3 0.9 perfect for YS</p>
...
export default ProxyGenFeatures;
